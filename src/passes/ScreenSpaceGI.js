...
export default class ScreenSpaceGI {
    constructor(width, height) {
        // 定义SSGI光线求交Shader、uniforms、材质、全屏四边形、渲染目标
        const intersectionShader = SSGIIntersectionShader;
        ...
        const spatialShader = SSGISpatialShader;
        ...
        const temporalShader = SSGITemporalShader;
